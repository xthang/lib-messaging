...
use lib_messaging_bridge::{describe_panic, jni_args};
...
#[no_mangle]
pub unsafe extern "C" fn Java_com_cystack_ready_libmessaging_internal_Native_Logger_1Initialize(
    env: JNIEnv,
    _class: JClass,
    max_level: jint,
    logger_class: JClass,
...
#[no_mangle]
pub unsafe extern "C" fn Java_com_cystack_ready_libmessaging_internal_Native_Logger_1SetMaxLevel(
    _env: JNIEnv,
    _class: JClass,
    max_level: jint,
) {
