...
impl<'a> SimpleArgTypeInfo<'a> for usize {
    type ArgType = jint;
    fn convert_from(_env: &JNIEnv, foreign: jint) -> SignalJniResult<Self> {
        match usize::try_from(foreign) {
            Err(_) => Err(SignalJniError::IntegerOverflow(format!(
                "{} to usize",
                foreign
            ))),
...
//                 env,
//                 foreign,
//                 jni_class_name!(com.cystack.ready.libmessaging.protocol.message.SignalMessage),
//                 Self::SignalMessage,
//             )
//             .transpose()
//         })
...
//                 env,
//                 foreign,
//                 jni_class_name!(com.cystack.ready.libmessaging.protocol.message.PreKeySignalMessage),
...
//                 env,
//                 foreign,
//                 jni_class_name!(com.cystack.ready.libmessaging.protocol.message.SenderKeyMessage),
...
//                 env,
//                 foreign,
//                 jni_class_name!(com.cystack.ready.libmessaging.protocol.message.PlaintextContent),
...
impl<T: ResultTypeInfo> ResultTypeInfo for Result<T, messaging_crypto::Error> {
    type ResultType = T::ResultType;
    fn convert_into(self, env: &JNIEnv) -> SignalJniResult<Self::ResultType> {
        T::convert_into(self?, env)
    }
