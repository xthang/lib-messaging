...
use messaging_crypto::Error as SignalCryptoError;
// use signal_pin::Error as PinError;
use std::convert::{TryFrom, TryInto};
use std::error::Error;
use std::fmt::Display;

pub(crate) use jni::objects::{AutoArray, JClass, JObject, ReleaseMode};
...
fn throw_error(env: &JNIEnv, error: SignalJniError) {
    ...
    let error = match error {
        ...
        //         jni_class_name!(com.cystack.ready.libmessaging.protocol.UntrustedIdentityException),
        //         addr.name(),
        //     );
        //     if let Err(e) = result {
        ...
        //             let args = jni_args!((
        //                 addr_object => com.cystack.ready.libmessaging.protocol.SignalProtocolAddress,
        //                 message => java.lang.String,
        //             ) -> void);
        //             Ok(env.new_object(
        //                 jni_class_name!(com.cystack.ready.libmessaging.protocol.NoSessionException),
        //                 args.sig,
        //                 &args.args,
        //             )?)
        //         });
        ...
        //             Ok(env.new_object(
        //                 jni_class_name!(
        //                     com.cystack.ready.libmessaging.protocol.InvalidRegistrationIdException
        //                 ),
        //                 args.sig,
        //                 &args.args,
        //             )?)
        ...
        //     let throwable = env.new_object(
        //         jni_class_name!(com.cystack.ready.libmessaging.metadata.SelfSendException),
        //         jni_signature!(() -> void),
        //         &[],
        //     );
    ...
    let exception_type = match error {
        ...
        | SignalJniError::SignalCrypto(SignalCryptoError::EncryptionError(_))
        | SignalJniError::SignalCrypto(SignalCryptoError::DecryptionError(_))
        ...
        //     jni_class_name!(com.cystack.ready.libmessaging.protocol.DuplicateMessageException)
        // }
        ...
        | SignalJniError::Signal(SignalProtocolError::InvalidKyberPreKeyId) => {
            jni_class_name!(com.cystack.ready.libmessaging.protocol.InvalidKeyIdException)
        }
        ...
        | SignalJniError::SignalCrypto(SignalCryptoError::InvalidKeySize) => {
            jni_class_name!(com.cystack.ready.libmessaging.protocol.InvalidKeyException)
        }
        ...
        //     jni_class_name!(com.cystack.ready.libmessaging.protocol.InvalidSessionException)
        // }
        ...
        | SignalJniError::SignalCrypto(SignalCryptoError::InvalidTag) => {
            jni_class_name!(com.cystack.ready.libmessaging.protocol.InvalidMessageException)
        }
        ...
        //     jni_class_name!(com.cystack.ready.libmessaging.protocol.InvalidVersionException)
        // }

        // SignalJniError::Signal(SignalProtocolError::LegacyCiphertextVersion(_)) => {
        //     jni_class_name!(com.cystack.ready.libmessaging.protocol.LegacyMessageException)
        // }
        ...
        //     jni_class_name!(com.cystack.ready.libmessaging.hsmenclave.TrustedCodeMismatchException)
        // }
        ...
        //     jni_class_name!(com.cystack.ready.libmessaging.attest.SgxCommunicationFailureException)
        // }
        // SignalJniError::Sgx(SgxError::DcapError(_)) => {
        //     jni_class_name!(com.cystack.ready.libmessaging.attest.DcapException)
        // }
        // SignalJniError::Sgx(SgxError::AttestationDataError { .. }) => {
        //     jni_class_name!(com.cystack.ready.libmessaging.attest.AttestationDataException)
        // }
        ...
        //     jni_class_name!(com.cystack.ready.libmessaging.zkgroup.InvalidInputException)
        // }

        // SignalJniError::ZkGroupVerificationFailure(_) => {
        //     jni_class_name!(com.cystack.ready.libmessaging.zkgroup.VerificationFailedException)
        // }

        // SignalJniError::UsernameError(UsernameError::CannotBeEmpty) => {
        //     jni_class_name!(com.cystack.ready.libmessaging.usernames.CannotBeEmptyException)
        // }

        // SignalJniError::UsernameError(UsernameError::CannotStartWithDigit) => {
        //     jni_class_name!(com.cystack.ready.libmessaging.usernames.CannotStartWithDigitException)
        // }

        // SignalJniError::UsernameError(UsernameError::MissingSeparator) => {
        //     jni_class_name!(com.cystack.ready.libmessaging.usernames.MissingSeparatorException)
        // }

        // SignalJniError::UsernameError(UsernameError::BadDiscriminator) => {
        //     jni_class_name!(com.cystack.ready.libmessaging.usernames.BadDiscriminatorException)
        // }

        // SignalJniError::UsernameError(UsernameError::BadNicknameCharacter) => {
        //     jni_class_name!(com.cystack.ready.libmessaging.usernames.BadNicknameCharacterException)
        // }

        // SignalJniError::UsernameError(UsernameError::NicknameTooShort) => {
        //     jni_class_name!(com.cystack.ready.libmessaging.usernames.NicknameTooShortException)
        // }

        // SignalJniError::UsernameError(UsernameError::NicknameTooLong) => {
        //     jni_class_name!(com.cystack.ready.libmessaging.usernames.NicknameTooLongException)
        // }
        ...
        //     jni_class_name!(com.cystack.ready.libmessaging.media.ParseException)
        // }
    };
...
//         env,
//         jni_class_name!(com.cystack.ready.libmessaging.protocol.SignalProtocolAddress),
    ...
    ( $typ:ty as $jni_name:ident ) => {
        paste! {
            ...
            pub unsafe extern "C" fn [<
                Java_com_cystack_ready_libmessaging_internal_Native_ $jni_name _1Destroy
            >](
                _env: jni::JNIEnv,
                _class: jni::JClass,
