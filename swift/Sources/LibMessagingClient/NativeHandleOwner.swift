...
public class NativeHandleOwner {
    ...
    internal class func destroyNativeHandle(_ handle: OpaquePointer) -> MsgFfiErrorRef? {
...
public class ClonableHandleOwner: NativeHandleOwner {
    ...
    internal class func cloneNativeHandle(_ newHandle: inout OpaquePointer?, currentHandle: OpaquePointer?) -> MsgFfiErrorRef? {
        fatalError("must be implemented by subclasses")
    }
}
