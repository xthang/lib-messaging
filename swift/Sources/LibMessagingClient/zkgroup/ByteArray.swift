...
public class ByteArray {
    ...
    init(_ newContents: [UInt8], checkValid: (MsgBorrowedBuffer) -> MsgFfiErrorRef?) throws {
    ...
    func withUnsafeBorrowedBuffer<Result>(_ callback: (MsgBorrowedBuffer) throws -> Result) throws -> Result {
